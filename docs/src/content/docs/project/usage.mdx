...
Currently, Genshi only has integration with React. You can use Genshi with any other view library, but you may need to write custom bindings to make it work.
